...
def import_doc(doctype, export_file, threads=5, max_retries=5):
...
# Customer Vehicle depends on Customer + Item + Vehicle Make/Model (all should exist by now)
import_doc("Customer Vehicle", "pos-static/export/Customer_Vehicle.json", threads=5)
print("\nDONE customer_vehicle")
