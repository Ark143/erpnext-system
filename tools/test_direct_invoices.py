...
print("\n--- TEST: Direct Intercompany Sales Invoice (Seller) ---")
try:
    ...
    print("SI Created & Submitted:", si['name'], "Total:", si.get('grand_total'))
except Exception as e:
    print("SI Error:", e)

print("\n--- TEST: Direct Intercompany Purchase Invoice (Buyer) ---")
try:
    pi = post_and_submit('Purchase Invoice', {
        ...
        'intercompany_invoice_reference': si['name'] if 'si' in locals() else '',
    ...
    print("PI Created & Submitted:", pi['name'], "Total:", pi.get('grand_total'))
except Exception as e:
    print("PI Error:", e)
