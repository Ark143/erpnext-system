...
print(json.dumps(out.get('message', {}).get('kpis'), indent=2))
print("Company sales:", len(out.get('message', {}).get('company_sales', [])))
print("Recent ops:", len(out.get('message', {}).get('recent_ops', [])))
