...
def create_document():
    ...
    src_path = r'c:\Users\josem\erpnext-system\docs\FULL_TECHNICAL_AND_FUNCTIONAL_DOCUMENTATION.md'
    ...
    # Save outputs (handle file lock if file is open in Microsoft Word)
    targets = [
        r'c:\Users\josem\erpnext-system\docs\ERPNext_Vehicle_Management_System_Documentation.docx',
        r'c:\Users\josem\erpnext-system\docs\ERPNext_Vehicle_Management_System_Documentation_Complete.docx',
        r'C:\Users\josem\.gemini\antigravity-ide\brain\ad9d29ca-966c-454f-b5c8-9ae935c95822\ERPNext_Vehicle_Management_System_Documentation.docx',
        r'C:\Users\josem\.gemini\antigravity-ide\brain\ad9d29ca-966c-454f-b5c8-9ae935c95822\ERPNext_Vehicle_Management_System_Documentation_Complete.docx'
    ]
    ...
    for path in targets:
        try:
            ...
            print(f"Warning: {path} is currently locked by another program (Word).")
