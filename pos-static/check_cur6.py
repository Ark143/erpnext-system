...
pp = frappe.db.get_value("POS Profile", {"company":"My Company"}, ["name","currency","price_list","warehouse"])
print("POS Profile:", pp)
# Mode of payment Cash account currency
...
# Try creating a bare POS Invoice for NELSON to reproduce
