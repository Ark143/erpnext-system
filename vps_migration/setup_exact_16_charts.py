...
ensure_chart("Sales Invoices by Customer", {
    "chart_type": "Group By",
...
ensure_chart("Vehicle Estimates by Status", {
    "chart_type": "Group By",
    "document_type": "Vehicle Estimate",
    "group_by_type": "Count",
    "group_by_based_on": "status",
    "type": "Donut",
    "filters_json": "[[\"Vehicle Estimate\",\"docstatus\",\"!=\",2]]"
})
...
workspace_charts = [
    ...
    {"chart_name": "Sales Invoices by Customer", "label": "Sales Invoices by Customer"},
    ...
    {"chart_name": "Vehicle Estimates by Status", "label": "Vehicle Estimates by Status"}
]
...
print("\n=== VERIFYING EXACTLY 16 WORKSPACE CHARTS ===")
all_pass = True
...
if all_pass:
    print(f"\n>>> EXACTLY {len(workspace_charts)} WORKSPACE CHARTS PASSED 100%! <<<")
