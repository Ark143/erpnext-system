...
# Vehicle Management doctypes to surface as shortcuts
shortcuts = [
    "Vehicle Make", "Vehicle Model", "Customer Vehicle", "Cashier Profile",
    "Inspection Template", "Item Part Cross Reference", "Item Vehicle Compatibility",
    "Bin Location", "Vehicle Service Reminder",
    "Vehicle POS Invoice", "Vehicle Inspection", "Vehicle Estimate", "Vehicle Job Order",
]
content = []
content.append(blk("header", {"text": "<span class=\"h4\"><b>Vehicle Management</b></span>"}, 12))
content.append(blk("shortcut", {"shortcut_name": "Vehicle POS Invoice", "col": 3}, 3))
content.append(blk("shortcut", {"shortcut_name": "Customer Vehicle", "col": 3}, 3))
content.append(blk("shortcut", {"shortcut_name": "Vehicle Inspection", "col": 3}, 3))
content.append(blk("shortcut", {"shortcut_name": "Vehicle Job Order", "col": 3}, 3))
content.append(blk("spacer", {}, 12))
