...
script_code = """
company = frappe.form_dict.company if hasattr(frappe, 'form_dict') and frappe.form_dict else None
...
frappe.response['message'] = {'status': 'success', 'tot_sales': tot_sales, 'count': len(invoices)}
"""
