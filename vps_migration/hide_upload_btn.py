...
with open("c:/Users/josem/erpnext-system/vps_migration/temp_patched3.html", "w", encoding="utf-8") as f:
    f.write(patched_html)

node_cmd = ["node", "-e",
    "const fs=require('fs');const h=fs.readFileSync('c:/Users/josem/erpnext-system/vps_migration/temp_patched3.html','utf8');"
...
print("SUCCESSFULLY HIDDEN UPLOAD BUTTON")
